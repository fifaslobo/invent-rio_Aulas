(function () {
    var API_BASE = "/api/fornecedores";
    var STORAGE_KEY = "fornecedores.adminApiKey";
    ...
    function bindDeleteActions() {
        var buttons = document.querySelectorAll(".js-delete-fornecedor");
        if (!buttons.length) {
            return;
        }
        ...
        Array.prototype.forEach.call(buttons, function (button) {
            button.addEventListener("click", function () {
                ...
                var modelo = button.getAttribute("data-modelo") || "este fornecedor";
                ...
                fetch(API_BASE + "/" + id, {
                    ...
                    .then(function (response) {
                        ...
                        window.location.href = "/fornecedores?status=deleted";
                    })
    ...
    function exportCompressed(canvas, quality, maxBytes, resolve, reject) {
        canvas.toBlob(function (blob) {
            ...
            if (blob.size <= maxBytes || quality <= 0.45) {
                resolve(new File([blob], "fornecedor.jpg", { type: "image/jpeg" }));
                return;
            }
    ...
    function redirectFromQrValue(value) {
        ...
        window.location.href = "/fornecedores/codigo/" + encodeURIComponent(extractCodigo(value));
    }
    ...
    function extractCodigo(value) {
        ...
        var match = trimmed.match(/\/fornecedores\/codigo\/([^/?#]+)/i);
        if (match && match[1]) {
    ...
    function showStatusFromQuery() {
        ...
        if (status === "created") {
            ...
            showFeedback("fornecedor apagado com sucesso.", "success");
        }
    }
